...
export function createMitochondrionCutawayModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  const socket_root_front_cutaway_0 = new THREE.Object3D();
  socket_root_front_cutaway_0.name = "front-cutaway";
  socket_root_front_cutaway_0.position.set(-0.15, 0.03, 0.72);
  socket_root_front_cutaway_0.rotation.set(0.0, 0.0, 0.0);
  socket_root_front_cutaway_0.userData.socket = {"id": "front-cutaway", "localPosition": [-0.15, 0.03, 0.72], "localRotation": [0, 0, 0]};
  node_root_0.add(socket_root_front_cutaway_0);
  sockets["root:front-cutaway"] = socket_root_front_cutaway_0;
