...
export function buildCoronaryAnatomy(ctx: CoronaryAnatomyContext): void {
  ...
  const illustrativeBranches: SurfaceBranchDefinition[] = [
    ...
    },
    {
      ...
      parentVessel: 'right-marginal-branch', rootY: -0.50, region: '右心室前外侧壁上段',
      stations: [[-0.50, 2.82, 0.019], [-0.65, 2.51, 0.012], [-0.80, 2.20, 0.005]],
    },
    {
      id: 'right-marginal-surface-branch-2', label: '右缘表面次级支 2', kind: 'artery', parent: rightSystem,
      parentVessel: 'right-marginal-branch', rootY: -0.93, region: '右心室前外侧壁中段',
      stations: [[-0.93, 2.80, 0.018], [-1.08, 2.50, 0.011], [-1.23, 2.20, 0.005]],
    },
    {
      id: 'pda-surface-branch-1', label: 'PDA 表面次级支 1', kind: 'artery', parent: rightSystem,
      parentVessel: 'posterior-descending-artery', rootY: -0.74, region: '左心室膈面上段',
    ...
    },
    {
      ...
      parentVessel: 'posterior-descending-artery', rootY: -1.25, region: '左心室膈面中段',
    ...
    },
    {
      ...
      parentVessel: 'great-cardiac-vein', rootY: -0.48, region: '左心室前外侧壁上段',
    ...
    },
    {
      ...
      parentVessel: 'great-cardiac-vein', rootY: -1.06, region: '左心室前外侧壁中下段',
    ...
    },
    {
      ...
      parentVessel: 'middle-cardiac-vein', rootY: -0.80, region: '右心室膈面上段',
    ...
    },
    {
      ...
      parentVessel: 'middle-cardiac-vein', rootY: -1.30, region: '右心室膈面中下段',
   ...
   * three-point cross-section gives the groove fat a low lobulated crown while
