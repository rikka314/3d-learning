...
export function buildCoronaryAnatomy(ctx: CoronaryAnatomyContext): void {
  ...
  const leftBifurcation = new THREE.Vector3(0.32, 0.32, 0.76);
  addVessel({
  ...
  const ladPoints = [
    leftBifurcation,
    surfaceAt(0.20, anteriorAngle(0.20), 0.042),
    surfaceAt(-0.10, anteriorAngle(-0.10), 0.040),
    ladDiagonalOneOrigin,
    surfaceAt(-0.73, anteriorAngle(-0.73), 0.035),
    ladDiagonalTwoOrigin,
    surfaceAt(-1.34, anteriorAngle(-1.34), 0.030),
    surfaceAt(-1.68, anteriorAngle(-1.68), 0.026),
    surfaceAt(-2.03, anteriorAngle(-2.03), 0.020),
  ];
  addVessel({
  ...
  const obtuseMarginalOrigin = surfaceAt(-0.27, 5.23, 0.033);
  const circumflexPoints = [
    leftBifurcation,
    surfaceAt(-0.12, 0.20, 0.040),
    surfaceAt(-0.20, 5.84, 0.038),
    surfaceAt(-0.24, 5.60, 0.036),
    obtuseMarginalOrigin,
    surfaceAt(-0.31, 4.72, 0.030),
    surfaceAt(-0.38, 4.05, 0.020),
  ];
  addVessel({
  ...
  const rightMarginalOrigin = surfaceAt(-0.14, 2.95, 0.037);
  const crux = surfaceAt(-0.40, 4.05, 0.038);
  addVessel({
    ...
    points: [
      ...
      surfaceAt(0.10, 2.50, 0.043),
      surfaceAt(0.01, 2.72, 0.040),
      rightMarginalOrigin,
      surfaceAt(-0.24, 3.20, 0.036),
      surfaceAt(-0.33, 3.62, 0.036),
      crux,
    ],
  ...
  addVessel({
    ...
    points: [
      rightMarginalOrigin,
      surfaceAt(-0.43, 2.84, 0.032),
      surfaceAt(-0.78, 2.80, 0.026),
      surfaceAt(-1.10, 2.79, 0.018),
      surfaceAt(-1.40, 2.78, 0.010),
    ],
  ...
  addVessel({
    ...
    points: [
      crux,
      surfaceAt(-0.66, posteriorAngle(-0.66), 0.033),
      surfaceAt(-0.96, posteriorAngle(-0.96), 0.029),
      surfaceAt(-1.28, posteriorAngle(-1.28), 0.024),
      surfaceAt(-1.58, posteriorAngle(-1.58), 0.018),
      surfaceAt(-1.87, posteriorAngle(-1.87), 0.010),
    ],
  ...
  const sinusLeftEnd = surfaceAt(-0.34, 5.60, 0.030);
  const sinusMiddle = surfaceAt(-0.34, 4.70, 0.035);
  const sinusRightJunction = surfaceAt(-0.33, 3.80, 0.034);
  addVessel({
    id: 'coronary-sinus',
    label: '冠状窦',
    kind: 'vein',
    ...
    points: [
      sinusLeftEnd,
      surfaceAt(-0.35, 5.18, 0.035),
      sinusMiddle,
      surfaceAt(-0.34, 4.22, 0.037),
      sinusRightJunction,
  ...
  addVessel({
    ...
    points: [
      surfaceAt(-1.95, anteriorAngle(-1.95) + 0.10, 0.030),
      surfaceAt(-1.55, anteriorAngle(-1.55) + 0.10, 0.036),
      surfaceAt(-1.12, anteriorAngle(-1.12) + 0.11, 0.041),
      surfaceAt(-0.68, anteriorAngle(-0.68) + 0.12, 0.045),
      surfaceAt(-0.30, anteriorAngle(-0.30) + 0.14, 0.047),
      surfaceAt(-0.20, 0.24, 0.044),
      surfaceAt(-0.25, 5.88, 0.039),
      sinusLeftEnd,
    ],
  ...
  addVessel({
    ...
    points: [
      surfaceAt(-1.90, posteriorAngle(-1.90) - 0.10, 0.025),
      surfaceAt(-1.55, posteriorAngle(-1.55) - 0.10, 0.031),
      surfaceAt(-1.17, posteriorAngle(-1.17) - 0.11, 0.037),
      surfaceAt(-0.79, posteriorAngle(-0.79) - 0.12, 0.042),
      surfaceAt(-0.50, posteriorAngle(-0.50) - 0.12, 0.044),
      sinusMiddle,
    ],
  ...
  addVessel({
    ...
    points: [
      surfaceAt(-1.31, 2.66, 0.022),
      surfaceAt(-0.91, 2.69, 0.027),
      surfaceAt(-0.54, 2.74, 0.032),
      surfaceAt(-0.20, 3.05, 0.037),
      surfaceAt(-0.27, 3.43, 0.038),
      sinusRightJunction,
    ],
  ...
  addFatBand('atrioventricular-groove-fat-band', avFat, [
    surfaceAt(-0.18, 0.28, 0.004),
    surfaceAt(-0.25, 5.72, 0.004),
    surfaceAt(-0.34, 5.10, 0.004),
    surfaceAt(-0.36, 4.48, 0.004),
    surfaceAt(-0.35, 3.86, 0.004),
    surfaceAt(-0.24, 3.18, 0.004),
    surfaceAt(-0.05, 2.62, 0.004),
