...
export function createHeartMaterials(): {
  ...
  const definitions: Record<MaterialId, {
    ...
    myocardium: { color: 0xa33b34, roughness: 0.46, coat: 0.18, coatRoughness: 0.32,
      profile: { colorVariation: 0.48, relief: 0.00135, grainScale: 72, roughnessVariation: 0.18, fiber: 0.8 } },
    atrial: { color: 0xb1534c, roughness: 0.49, coat: 0.19, coatRoughness: 0.33,
      profile: { colorVariation: 0.36, relief: 0.00120, grainScale: 80, roughnessVariation: 0.15, fiber: 0.45 } },
    arterial: { color: 0xb52a22, roughness: 0.39, coat: 0.24, coatRoughness: 0.30,
      profile: { colorVariation: 0.19, relief: 0.00045, grainScale: 86, roughnessVariation: 0.10, fiber: 0.15 } },
    venous: { color: 0x28548c, roughness: 0.42, coat: 0.22, coatRoughness: 0.31,
      profile: { colorVariation: 0.21, relief: 0.00038, grainScale: 90, roughnessVariation: 0.10, fiber: 0.12 } },
