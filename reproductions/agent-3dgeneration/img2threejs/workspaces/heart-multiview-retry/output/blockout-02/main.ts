...
const lightSettings = {
  reference: {
    hemi: [0xfff5ee, 0x756968, 1.3] as const,
    key: [0xffeee7, 2.05, [-3, 5, 6]] as const,
    fill: [0xe4ecff, 0.8, [3, -2, 5]] as const,
  },
  neutral: {
    hemi: [0xfffdf8, 0x6b6462, 1.15] as const,
    key: [0xfffaf5, 1.85, [-3.5, 4.5, 6]] as const,
    fill: [0xe9efff, 0.72, [4, 2, 4.5]] as const,
  },
  grazing: {
...
const cameraFill = new THREE.DirectionalLight(0xfff4ee, 0.48);
