...
export function buildCoronaryAnatomy(ctx: CoronaryAnatomyContext): void {
  ...
  const obtuseMarginalOrigin = surfaceAt(avGrooveY(5.23), 5.23, 0.033);
  const circumflexPoints = [
    leftBifurcation,
    ...surfaceSweep([
      [0.20, anteriorAngle(0.20), 0.040],
      [avGrooveY(0.80), 0.80, 0.040],
      [avGrooveY(0.20), 0.20, 0.039],
      [avGrooveY(5.84), 5.84, 0.038],
      [avGrooveY(5.60), 5.60, 0.036],
      [avGrooveY(5.23), 5.23, 0.033],
      [avGrooveY(4.72), 4.72, 0.030],
      [avGrooveY(4.05), 4.05, 0.020],
    ]).slice(1),
  ];
  addVessel({
  ...
  const rightMarginalOrigin = surfaceAt(avGrooveY(2.95), 2.95, 0.037);
  const crux = surfaceAt(avGrooveY(4.05), 4.05, 0.038);
  addVessel({
    ...
    points: [
      ...
      ...surfaceSweep([
        [avGrooveY(2.50), 2.50, 0.043],
        [avGrooveY(2.72), 2.72, 0.040],
        [avGrooveY(2.95), 2.95, 0.037],
        [avGrooveY(3.20), 3.20, 0.036],
        [avGrooveY(3.62), 3.62, 0.036],
        [avGrooveY(4.05), 4.05, 0.038],
      ]),
    ],
  ...
  const sinusLeftEnd = surfaceAt(avGrooveY(5.60), 5.60, 0.030);
  const middleVeinJunction = surfaceAt(avGrooveY(4.02), 4.02, 0.041);
  const sinusRightJunction = surfaceAt(avGrooveY(3.80), 3.80, 0.034);
  addVessel({
    id: 'coronary-sinus',
    label: '冠状窦',
    kind: 'vein',
    ...
    points: [
      ...surfaceSweep([
        [avGrooveY(5.60), 5.60, 0.030],
        [avGrooveY(5.18), 5.18, 0.035],
        [avGrooveY(4.70), 4.70, 0.035],
        [avGrooveY(4.22), 4.22, 0.037],
        [avGrooveY(4.02), 4.02, 0.041],
        [avGrooveY(3.80), 3.80, 0.034],
      ]),
  ...
  addVessel({
    ...
    points: [
      ...surfaceSweep([
        [-1.95, anteriorAngle(-1.95) + 0.10, 0.030],
        [-1.55, anteriorAngle(-1.55) + 0.10, 0.036],
        [-1.12, anteriorAngle(-1.12) + 0.11, 0.041],
        [-0.68, anteriorAngle(-0.68) + 0.12, 0.045],
        [-0.24, anteriorAngle(-0.24) + 0.12, 0.047],
        [0.14, anteriorAngle(0.14) + 0.10, 0.048],
        [avGrooveY(1.10), 1.10, 0.049],
        [avGrooveY(0.80), 0.80, 0.048],
        [avGrooveY(0.50), 0.50, 0.047],
        [avGrooveY(0.20), 0.20, 0.045],
        [avGrooveY(6.05), 6.05, 0.042],
        [avGrooveY(5.88), 5.88, 0.038],
        [avGrooveY(5.60), 5.60, 0.030],
      ]).slice(0, -1),
      sinusLeftEnd,
    ],
  ...
  addVessel({
    ...
    points: [
      ...surfaceSweep([
        [-1.90, posteriorAngle(-1.90) - 0.10, 0.025],
        [-1.55, posteriorAngle(-1.55) - 0.10, 0.031],
        [-1.17, posteriorAngle(-1.17) - 0.11, 0.037],
        [-0.79, posteriorAngle(-0.79) - 0.10, 0.042],
        [-0.50, posteriorAngle(-0.50) - 0.05, 0.044],
        [avGrooveY(4.02), 4.02, 0.041],
      ]).slice(0, -1),
      middleVeinJunction,
    ],
