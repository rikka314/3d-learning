...
def npx_command() -> str:
    """Return the directly executable npx launcher for this platform."""
    return "npx.cmd" if os.name == "nt" else "npx"


def node_bin(root: Path, name: str) -> Path:
    """Resolve a package binary to the Windows cmd shim when required."""
